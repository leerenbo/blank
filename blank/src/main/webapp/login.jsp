	...
	$(function() {
		...
		var loginFun = function() {
			...
			if ($form.length == 1 && $form.form('validate')) {
				...
				$.post(datalook.contextPath + '/sysUser!noSnSy_login.action', $form.serialize(), function(result) {
					if (result.success) {
			...
			<div title="管理员登录" style="overflow: hidden; padding: 10px;">
				...
				<input type="hidden" name="status" value="1"/>
					<table class="table" style="width: 100%; height: 100%;">
						<tr>
							<th width="50">账号</th>
							<td><input name="data.username" class="easyui-validatebox" data-options="required:true" value="admin" style="width: 210px;" /></td>
						</tr>
						<tr>
							<th>密码</th>
							<td><input name="data.password" type="password" class="easyui-validatebox" data-options="required:true" value="admin" style="width: 210px;" /></td>
						</tr>
					</table>
				</form>
			</div>
