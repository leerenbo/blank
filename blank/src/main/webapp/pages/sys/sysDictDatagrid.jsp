...
<body class="easyui-layout" data-options="fit:true,border:false">
	<div id="eztoolbar" style="display: none;">
		...
		<div>
			<s:if test="@com.datalook.util.base.SecurityUtil@havePermission('/sysDict!save')">
				<a onclick="save();" href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'ext-icon-note_add',plain:true">添加</a>
			</s:if>
			
			<s:if test="@com.datalook.util.base.SecurityUtil@havePermission('/sysDict!getById')">
			...
			<s:if test="@com.datalook.util.base.SecurityUtil@havePermission('/sysDict!update')">
			...
			<s:if test="@com.datalook.util.base.SecurityUtil@havePermission('/sysDict!deletePhysical')">
