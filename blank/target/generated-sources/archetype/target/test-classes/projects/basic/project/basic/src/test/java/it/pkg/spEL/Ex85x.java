...
public class Ex85x {
	...
	public void Constructors() {
		...
		Inventor einstein = p.parseExpression("new it.pkg.spEL.Inventor('Albert Einstein', 'German')").getValue(Inventor.class);
		System.out.println(einstein);
		// create new inventor instance within add method of List
		p.parseExpression("Members.add(new it.pkg.spEL.Inventor('Albert Einstein', 'German'))").getValue(societyContext);
	...
	public void Functions() throws NoSuchMethodException, SecurityException {
		...
		String helloWorldReversed2 = parser.parseExpression("T(it.pkg.spEL.StringUtils).reverseString('hello')").getValue(context, String.class);
