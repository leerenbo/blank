...
import it.pkg.util.base.MD5Util;
...
public class SysUserAction extends BaseAction<SysUser> {
	...
	/**
	 * @see it.pkg.action.sys.ISysUserAction#noSnSy_logout()
	 * 
	 *      功能描述： 时间：2014年9月29日
	 * @author: lirenbo
	 */
	...
	/**
	 * @see it.pkg.action.sys.ISysUserAction#noSnSy_login()
	 * 
	 *      功能描述： 时间：2014年9月29日
	 * @author: lirenbo
	 */
	...
	/**
	 * @see it.pkg.action.sys.ISysUserAction#grantSysRole()
	 * 
	 *      功能描述： 时间：2014年9月29日
	 * @author: lirenbo
	...
	/**
	 * @see it.pkg.action.sys.ISysUserAction#noSy_getRolesByUserId()
	 * 
	 *      功能描述： 时间：2014年9月29日
	 * @author: lirenbo
	 * @throws IllegalAccessException
