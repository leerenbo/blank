...
import it.pkg.exception.base.ToWebException;
...
public class ExceptionAspect {
	...
	@Order(2000)
	@AfterThrowing(value = "it.pkg.aop.base.SystemArchitecture.inActionLayer()", throwing = "t")
	...
	@Order(500)
	@AfterThrowing(value = "it.pkg.aop.base.SystemArchitecture.inServiceLayer()", throwing = "toWebException")
