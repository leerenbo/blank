...
public class MonitorUtil {
	...
	public double getCpuRatio() {
		...
		if (osName.toLowerCase().startsWith("windows")) {
			return cpuRatio = MonitorUtil.getCpuRatioForWindows();
		} else {
			return cpuRatio = MonitorUtil.getCpuRateForLinux();
		}
	}
	...
	private static double getCpuRatioForWindows() {
		try {
			String procCmd = System.getenv("windir") + "${symbol_escape}${symbol_escape}system32${symbol_escape}${symbol_escape}wbem${symbol_escape}${symbol_escape}wmic.exe process get Caption,CommandLine," + "KernelModeTime,ReadOperationCount,ThreadCount,UserModeTime,WriteOperationCount";
			// 取进程信息
