...
import ${package}.filter.base.FastjsonFilter;
import ${package}.model.sys.SysExcelUpload;
import ${package}.model.sys.easyui.Grid;
...
import ${package}.util.base.DateUtil;
...
@Namespace("/")
@Action
@Result(name = "download", type = "stream", params = { "contentType", "application/octet-stream", "inputName", "inputStream", "contentDisposition", "attachment;filename=${symbol_escape}"${symbol_dollar}{fileName}${symbol_escape}"", "bufferSize", "4096" })
public class BaseAction<T> extends ActionSupport {
	...
	/**
	 * @see ${package}.wanhui.action.base.IBaseAction${symbol_pound}writeJsonByFilter(java.lang.Object,
	...
	public void writeJsonByFilter(Object object, String[] includesProperties, String[] excludesProperties) {
		try {
			...
			if (StringUtils.indexOfIgnoreCase(User_Agent, "MSIE 6") > -1) {
				// 使用SerializerFeature.BrowserCompatible特性会把所有的中文都会序列化为${symbol_escape}${symbol_escape}uXXXX这种格式，字节数会多一些，但是能兼容IE6
