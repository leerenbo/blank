	...
	var deleteByStatus = function() {
		...
		parent.${symbol_dollar}.messager.confirm('询问', '您确定要删除记录？', function(r) {
			if (r) {
				...
				${symbol_dollar}.post(ez.contextPath + '/sysUser!deleteByStatus.action', {
					'ids' : ids.join(',')
				}, function() {
...
<body class="easyui-layout" data-options="fit:true,border:false">
	<div id="eztoolbar" style="display: none;">
		...
		<div>
			<s:if test="@${package}.util.base.SecurityUtil@havePermission('/sysUser!save')">
				<a onclick="save();" href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'ext-icon-note_add',plain:true">添加</a>
			</s:if>
			<s:if test="@${package}.util.base.SecurityUtil@havePermission('/sysUser!getById')">
			...
			<s:if test="@${package}.util.base.SecurityUtil@havePermission('/sysUser!update')">
			...
			<s:if test="@${package}.util.base.SecurityUtil@havePermission('/sysUser!grantSysRole')">
			...
			<s:if test="@${package}.util.base.SecurityUtil@havePermission('/sysUser!deleteByStatus')">
