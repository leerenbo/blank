		...
		<script type="text/javascript">
			${symbol_dollar}(function() {
				...
				${symbol_dollar}("${symbol_pound}readCard").click(function(){
					...
					${symbol_dollar}("${symbol_pound}cardpwd").val(cardInfo.cardpwd);
					${symbol_dollar}("${symbol_pound}employeenumber").val(cardInfo.employeenumber);
					${symbol_dollar}("${symbol_pound}employeename").val(cardInfo.employeename);
				});
				/* ---------------读卡end--------------- */
			});
