...
<script type="text/javascript">
	...
	${symbol_dollar}(function() {
		...
		mainTabs = ${symbol_dollar}('${symbol_pound}mainTabs').tabs({
			fit : true,
			border : false,
			tools : [ {
...
<div id="passwordDialog" title="修改密码" style="display: none;">
	<form method="post" class="form" onsubmit="return false;">
		<table class="table">
			...
			<tr>
				<th>重复密码</th>
				<td><input type="password" class="easyui-validatebox" data-options="required:true,validType:'eqPwd[${symbol_escape}'${symbol_pound}password${symbol_escape}']'" /></td>
			</tr>
		</table>
	</form>
</div>
