...
public class Ex85x {
	...
	public void Operators() {
		...
		// evaluates to true
		boolean trueValue3 = parser.parseExpression("'5.00' matches '^-?${symbol_escape}${symbol_escape}d+(${symbol_escape}${symbol_escape}.${symbol_escape}${symbol_escape}d{2})?${symbol_dollar}'").getValue(Boolean.class);
		System.out.println(trueValue3);

		// evaluates to false
		boolean falseValue3 = parser.parseExpression("'5.0067' matches '^-?${symbol_escape}${symbol_escape}d+(${symbol_escape}${symbol_escape}.${symbol_escape}${symbol_escape}d{2})?${symbol_dollar}'").getValue(Boolean.class);
	...
	public void Constructors() {
		...
		Inventor einstein = p.parseExpression("new ${package}.spEL.Inventor('Albert Einstein', 'German')").getValue(Inventor.class);
		System.out.println(einstein);
		// create new inventor instance within add method of List
		p.parseExpression("Members.add(new ${package}.spEL.Inventor('Albert Einstein', 'German'))").getValue(societyContext);
	...
	public void Variables() {
		...
		parser.parseExpression("Name = ${symbol_pound}newName").getValue(context);
	...
	public void thisandrootvariables() {
		...
		List<Integer> primesGreaterThanTen = (List<Integer>) parser.parseExpression("${symbol_pound}primes.?[${symbol_pound}this>10]").getValue(context);
	...
	public void Functions() throws NoSuchMethodException, SecurityException {
		...
		String helloWorldReversed = parser.parseExpression("${symbol_pound}reverseString('hello')").getValue(context, String.class);
		System.out.println(helloWorldReversed);

		String helloWorldReversed2 = parser.parseExpression("T(${package}.spEL.StringUtils).reverseString('hello')").getValue(context, String.class);
	...
	public void IfThenElse() {
		...
		String expression = "isMember(${symbol_pound}queryName)? ${symbol_pound}queryName + ' is a member of the ' + Name + ' Society' : ${symbol_pound}queryName + ' is not a member of the ' + Name + ' Society'";
	...
	public void CollectionSelection() {
		...
		h.put("a", 12);
		Map newMap = (Map) parser.parseExpression("${symbol_pound}root.?[value<27]").getValue(h);
	...
	public void Expressiontemplating() {
		...
		String randomPhrase = parser.parseExpression("random number is ${symbol_pound}{T(java.lang.Math).random()}", new TemplateParserContext()).getValue(String.class);
